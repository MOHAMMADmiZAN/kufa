...
if (isset($dataBase)) {
    ...
    if (isset($dashBoardUserId)) {
        $dashBoardUserIdView = "SELECT * FROM `users` WHERE `id` = '$dashBoardUserId'";
        if (isset($dashBoardUserIdView)) {
            $dashBoardUserIdViewQuery = $dataBase->query($dashBoardUserIdView);
            if (isset($dashBoardUserIdViewQuery)) {
                $dashBoardUserIdViewAssoc = $dashBoardUserIdViewQuery->fetch_assoc();
            }
        }
    }
} else {
...
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        ...
        <a href="portfolio.php" class="sl-menu-link <?= $linkEnd === 'portfolio.php' ? 'active' : '' ?>">
            <div class="sl-menu-item">
                <i class="menu-item-icon fas fa-portrait tx-24"></i>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        ...
                        <li><a href="singout.php"><i class="icon ion-power"></i> Sign Out</a></li>
                    </ul>
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
        </nav>
